  ...
  return (
    <footer className="bg-white text-inktext pt-16 pb-10 border-t border-gray-100">
      ...
      <div className="max-w-screen-2xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10 pb-12 border-b border-gray-100">
          ...
          <div className="lg:col-span-4 flex flex-col justify-between">
            <div>
              ...
              <p className="text-inktext/70 text-sm leading-relaxed max-w-sm">
          ...
          <div className="lg:col-span-3">
            ...
            {/* Inner Grid 2 Kolom */}
            <div className="grid grid-cols-2 gap-x-4 gap-y-2.5 text-sm text-inktext/75 font-medium">
            ...
            <ul className="space-y-3.5 text-sm text-inktext/75">
              <li>
                <a
                  ...
                  className="flex items-center gap-2.5 text-navy hover:text-blue-600 transition-colors font-semibold w-fit"
                >
                  <Mail className="w-4 h-4 shrink-0 text-navy hover:text-blue-600" />
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-2.5 text-navy hover:text-blue-600 transition-colors font-semibold w-fit"
                >
                  <Phone className="w-4 h-4 shrink-0 text-navy hover:text-blue-600" />
                  <span>(021) 1234567</span>
                </a>
              </li>
              <li>
                <div className="flex items-start gap-2.5 text-inktext/70 leading-relaxed">
                  <MapPin className="w-4 h-4 shrink-0 text-navy hover:text-blue-600 mt-1" />
                  <span>
          ...
          <div className="lg:col-span-3 flex flex-col justify-start">
            <div className="flex items-center justify-between mb-2">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-xs font-semibold text-navy hover:text-blue-600 flex items-center gap-1 transition-colors"
              >
            ...
            <div className="w-full h-48 rounded-xl overflow-hidden border border-gray-200/80 shadow-sm relative group bg-gray-100">
              <iframe
        ...
        <div className="pt-8 flex justify-center items-center text-xs md:text-sm text-inktext/60">
          <p className="text-center">
            Copyright © {new Date().getFullYear()}{' '}
            <Link to="/" className="font-bold text-navy hover:text-blue-600 transition-colors">
