    ...
    <div className="bg-white text-inktext min-h-screen pb-20">
      <div className="max-w-screen-2xl mx-auto px-6 md:px-12 -mt-2 py-10 space-y-12">
        ...
        <RevealSection className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start pt-4">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="flex items-start gap-5">
              ...
              <div className="space-y-1 pt-0.5">
                ...
                <p className="text-sm text-inktext/70 font-light leading-relaxed">
            ...
            <div className="bg-[#f8fafc] border border-gray-100 p-6 rounded-3xl shadow-sm space-y-3 mt-6">
          ...
          <div className="lg:col-span-7 bg-white border border-gray-100 rounded-[2.5rem] p-8 md:p-10 shadow-xl shadow-slate-100">
            <form onSubmit={handleSubmit} className="space-y-5" noValidate>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-[#f8fafc] border border-gray-200 rounded-2xl px-4 py-2 text-sm font-medium focus:outline-none focus:border-navy focus:bg-white focus:ring-1 focus:ring-navy transition-all resize-none"
                />
                {errors.message && (
                  <p className="text-red-600 text-xs mt-1.5 flex items-center gap-1 font-medium">
                    <AlertCircle className="w-3.5 h-3.5" />
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full bg-navy hover:bg-blue-600 text-white font-bold text-sm py-3.5 rounded-2xl transition-all duration-300 shadow-md hover:shadow-lg disabled:opacity-60 flex items-center justify-center gap-2 cursor-pointer mt-2"
              >
                {submitting ? (
                  <>
              ...
              {status === 'success' && (
                <div className="flex items-start gap-3 bg-green-50 border border-green-200 text-green-800 p-4 rounded-2xl text-xs font-medium animate-fade-in mt-4">
              ...
              {status === 'error' && (
                <div className="flex items-start gap-3 bg-red-50 border border-red-200 text-red-800 p-4 rounded-2xl text-xs font-medium animate-fade-in mt-4">
